...
$query = $pdo->query("SELECT * FROM tbaluno");
$res = $query->fetchAll(PDO::FETCH_ASSOC);
...
$query = $pdo->query("SELECT * FROM pgto_matriculas where data_vencimento < curDate()");
$res = $query->fetchAll(PDO::FETCH_ASSOC);
$totalMatriculas = @count($res);

$query = $pdo->query("SELECT * FROM pgto_matriculas where data_vencimento < curDate() and pago != 'Sim'");
$res = $query->fetchAll(PDO::FETCH_ASSOC);
...
for ($i=0; $i < @count($res); $i++) { 
	...
	$res2 = $query2->fetchAll(PDO::FETCH_ASSOC);
		...
		$query3 = $pdo->query("SELECT * FROM pgto_matriculas where matricula = '$id_mat' and data_vencimento < curDate() and pago != 'Sim' ");
	...
	<div class="col-xl-3 col-md-6 mb-4">
		<div class="card border-left-primary shadow h-100 py-2">
			<div class="card-body">
				<div class="row no-gutters align-items-center">
					<div class="col mr-2">
						<div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Contas Vencendo Hoje</div>
